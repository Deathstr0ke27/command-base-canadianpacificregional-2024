...
public class TurnLeft extends Command {
    ...
    public TurnLeft(DriveSubsystem dtRight2, DriveSubsystem dtRight1, DriveSubsystem dtLeft2, DriveSubsystem dtLeft1, double tempo) {
    ...
    @Override
    public void execute() {
        dtRight2.setSpeed(0.5);
        dtRight1.setSpeed(0.5);
        dtLeft2.setSpeed(0.5);
        dtLeft1.setSpeed(0.5);
    }
    ...
    public boolean isFinished() {
        return timer.hasElapsed(tempo); // Tempo que o robo vai fazer a curva
    }
}